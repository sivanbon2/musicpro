    ...
    setResetInputsListener();
      ...
      $("#add-new-playlist-button").on('click', function() {
        ...
        $("#addBtn").click(function () {
            ...
            var newRow=`<div class="newSong">
            <label for="newSongUrl${num}">Song URL
              <input type="text" id="newSongUrl${num}" name="newSongUrl${num}" class="newSongUrl">
            </label>
            <label for="newSongName${num}">Name
              <input type="text" id="newSongName${num}" name="newSongName${num}" class="newSongName">
            </label>
          </div>`;
